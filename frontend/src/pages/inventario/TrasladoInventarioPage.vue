    ...
    <div class="row q-col-gutter-md">
      <div class="col-12">
        <q-card class="glass-card shadow-1 rounded-borders">
          <q-card-section>
            <div class="text-h5 text-weight-bold text-primary">Traslado de Inventario</div>
          ...
          <q-card-section class="q-pa-xl text-center">
            ...
            <div class="text-body2 text-grey-4">Próximamente verás aquí el contenido de Traslado de Inventario</div>
          </q-card-section>
        </q-card>
      </div>
    </div>
...
// Lógica de la página Traslado de Inventario
</script>
